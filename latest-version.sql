...
INSERT INTO `userType` VALUES (1,'Admin','2023-04-19 14:44:07','2023-04-19 14:44:07'),(2,'Colaborator','2023-04-19 14:44:07','2023-04-19 14:44:07'),(3,'Company','2023-04-19 14:44:07','2023-04-19 14:47:07'),(4,'Candidate','2023-04-19 14:44:07','2023-04-19 14:44:07');
...
CREATE TABLE `users` (
  ...
  `addressComplement` varchar(150) DEFAULT NULL,
  `addressNeighborhood` varchar(100) DEFAULT NULL,
  `addressCity` varchar(100) DEFAULT NULL,
  `addressState` varchar(50) DEFAULT NULL,
  `addressZipCode` varchar(50) DEFAULT NULL,
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `users_has_user_type_FK` (`userType`),
  CONSTRAINT `users_has_user_type_FK` FOREIGN KEY (`userType`) REFERENCES `userType` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `users` VALUES (1,'Vinicius Mocci',1,'vinicius.mocci@hotmail.com','448.753.978-10','','1997-05-21',NULL,NULL,NULL,NULL,NULL,NULL,'2023-04-19 15:00:13','2023-05-05 14:20:41'),(3,'Carl Johson',3,'carl.johnson@gmail.com','666.666.666-99','','1997-05-21',NULL,NULL,NULL,NULL,NULL,NULL,'2023-05-05 15:02:14','2023-06-06 11:42:43'),(4,'Caroline Salgado',1,'caalex.ss@gmail.com','473.233.258-70','','1997-05-14',NULL,NULL,NULL,NULL,NULL,NULL,'2023-05-05 15:10:07','2023-05-05 15:10:07'),(5,'Islan',1,'islan.gomes@gmail.com','666.666.666-66','','1997-05-26',NULL,NULL,NULL,NULL,NULL,NULL,'2023-05-08 14:33:12','2023-05-08 14:33:31');
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `jobs` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
LOCK TABLES `jobContracts` WRITE;
/*!40000 ALTER TABLE `jobContracts` DISABLE KEYS */;
INSERT INTO `jobContracts` VALUES (1,'Full Time','2023-06-06 11:52:09','2023-06-06 11:52:09'),(2,'Part Time','2023-06-06 11:52:10','2023-06-06 11:52:10'),(3,'Temporary','2023-06-06 11:52:13','2023-06-06 11:52:13');
/*!40000 ALTER TABLE `jobContracts` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `jobOpportunities` (
  ...
  `updatedat` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `jobOpportunities_has_user_FK` (`companyID`),
  KEY `jobOpportunities_has_job_type_FK` (`jobTypeID`),
  KEY `jobOpportunities_has_job_contract_FK` (`jobContractID`),
  CONSTRAINT `jobOpportunities_has_job_contract_FK` FOREIGN KEY (`jobContractID`) REFERENCES `jobContracts` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `jobOpportunities_has_job_type_FK` FOREIGN KEY (`jobTypeID`) REFERENCES `jobTypes` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `jobOpportunities_has_user_FK` FOREIGN KEY (`companyID`) REFERENCES `users`.`users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `jobOpportunities` VALUES (1,'Sr Back End Golang Developer',3,'Here you will work for free =)',1,1,'2023-06-06 11:55:24','2023-06-06 11:56:44');
...
INSERT INTO `jobTypes` VALUES (1,'On Site','2023-06-06 11:47:23','2023-06-06 11:47:23'),(2,'Hybrid','2023-06-06 11:48:02','2023-06-06 11:48:02'),(3,'Home Office','2023-06-06 11:48:08','2023-06-06 11:48:08');
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2023-04-18 19:13:00',NULL),('diagnostics.include_raw','OFF','2023-04-18 19:13:00',NULL),('ps_thread_trx_info.max_length','65535','2023-04-18 19:13:00',NULL),('statement_performance_analyzer.limit','100','2023-04-18 19:13:00',NULL),('statement_performance_analyzer.view',NULL,'2023-04-18 19:13:00',NULL),('statement_truncate_len','64','2023-04-18 19:13:00',NULL);
...
-- Dump completed on 2023-06-08 13:16:03
